...
object UserUnRegisteredCorrelationApp {
 ...
 def main(args: Array[String]) {
   ...
   val user_reg_path = "hdfs://apollo-phx-nn-ha/user/hive/warehouse/mktng.db/unregistered_sessions_xid_parquet"
   ...
   .save("hdfs://apollo-phx-nn-ha/user/hive/warehouse/mktng.db/unregistered_mktng_corr")
 }
}
