/* post_bbowa_channel_event_type_analysis.scala */
import org.apache.spark.sql._
import org.apache.spark.sql.functions._
import scala.collection.mutable
import scala.collection._

object PostBBOWAChannelEventAnalysisApp {

 def main(args: Array[String]) {

    val spark = SparkSession.builder.appName("post_bbowa_channel_event_analysis").master("yarn").getOrCreate()
    ...
    */
    ...
    channel_name_encoder.write.option("sep","\t").mode("overwrite").csv("hdfs://apollo-phx-nn-ha/user/hive/warehouse/attrib.db/post_bbowa_channel_event_analysis_encoder")
   ...
   encoded_channels.write.option("sep","\t").mode("overwrite").csv("hdfs://apollo-phx-nn-ha/user/hive/warehouse/attrib.db/post_bbowa_channel_event_analysis")
